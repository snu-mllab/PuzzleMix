...
DATA=/data_large/readonly/ImageNet-Fast/imagenet-sz/352

#DATA=/data_large/readonly/ImageNet-Fast/imagenet
...
END1=~/slurm_tutorial_v7/fast_is_better_than_free_imagenet/trained_models/fast_phase1_${NAME}/checkpoint_epoch300.pth.tar
END2=~/slurm_tutorial_v7/fast_is_better_than_free_imagenet/trained_models/fast_phase2_${NAME}/checkpoint_epoch40.pth.tar
END3=~/slurm_tutorial_v7/fast_is_better_than_free_imagenet/trained_models/fast_phase3_${NAME}/checkpoint_epoch100.pth.tar

# training for phase 1
python -u main_fast.py $DATA352 -c $CONFIG1 --output_prefix $PREFIX1 | tee $OUT1

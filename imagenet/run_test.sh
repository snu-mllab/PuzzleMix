...
END1=~/slurm_tutorial_v7/fast_is_better_than_free_imagenet/trained_models/fast_phase1_${NAME}/checkpoint_epoch30.pth.tar
END2=~/slurm_tutorial_v7/fast_is_better_than_free_imagenet/trained_models/fast_phase2_${NAME}/checkpoint_epoch56.pth.tar
END3=~/slurm_tutorial_v7/fast_is_better_than_free_imagenet/trained_models/fast_phase3_${NAME}/checkpoint_epoch58.pth.tar
...
python -u main_test.py $DATA -c $CONFIG3 --output_prefix $PREFIX3 --resume $END3 --evaluate | tee $EVAL3

...
def mixup_graph(input1, grad1, indices, block_num=2, alpha=0.5, beta=0., gamma=0., eta=0.2, neigh_size=2, n_labels=2, mean=None, std=None, transport=False, t_eps=10.0, dataset=None, mp=None):
    '''Puzzle Mix'''
    ...
    if transport:
        ...
        if dataset == 'imagenet':
            ...
            try:
                ...
                raise AssertionError("** GPU memory is lacking while transporting. Reduce the t_batch_size value in this function (mixup.transprort) **")
        else:
